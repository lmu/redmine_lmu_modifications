...
Dispatcher.to_prepare do  
  unless ProjectsController.included_modules.include?(RedmineProjectsExtensions::Patches::ProjectsControllerPatch)
    ProjectsController.send(:include, RedmineProjectsExtensions::Patches::ProjectsControllerPatch)
  end
end